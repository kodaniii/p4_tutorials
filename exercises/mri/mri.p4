...
struct metadata {
    ...
    parser_metadata_t   parser_metadata;    //meta.parser_metadata.remaining <- hdr.mri.count
}
...
control MyEgress(inout headers hdr,
    ...
    action add_swtrace(switchID_t swid) {
        ...
        */
        ...
        hdr.ipv4.ihl = hdr.ipv4.ihl + 2;    //2 * 4B = 8B
        hdr.ipv4.totalLen = hdr.ipv4.totalLen + 8;  //8 * 1B = 8B
        hdr.ipv4_option.optionLength = hdr.ipv4_option.optionLength + 8;    //8B
    }
